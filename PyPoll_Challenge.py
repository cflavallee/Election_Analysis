...
with open(file_to_save, "w") as txt_file:
    ...
    for counties_name in counties_list:

        # 6b: Retrieve the county vote count.
        turnout_count = counties_votes.get(counties_name)
        ...
        if (turnout_count > highest_turnout) and (voter_turnout_county > turnout_percentage):

            highest_turnout = turnout_count
            largest_county_turnout = counties_name
            turnout_percentage = voter_turnout_county
